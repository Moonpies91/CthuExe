          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <div className="text-red-300/80 font-mono text-xs leading-relaxed">
                <p className="mb-2">
                  <strong>This is an experimental project.</strong> Only use crypto you can afford to lose entirely. You are unlikely to be protected if something goes wrong.
                </p>
                <p>
